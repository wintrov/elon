...
<path opacity="0.4" d="M16 12H22M22 12L19 9M22 12L19 15" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
<path d="M8 12H2M2 12L5 9M2 12L5 15M12 8V2M12 2L9 5M12 2L15 5M12 16V22M12 22L9 19M12 22L15 19" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
</svg>

	</template>
	<template v-else-if="variant === 'duotone'">
		<svg :width="width" :height="height" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
<path opacity="0.12" d="M2 12L12 2L22 12L12 22L2 12Z" fill="currentColor"/>
...
<path d="M16 12H22M22 12L19 9M22 12L19 15M8 12H2M2 12L5 9M2 12L5 15M12 8V2M12 2L9 5M12 2L15 5M12 16V22M12 22L9 19M12 22L15 19" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
	...
	<template v-else-if="variant === 'gestalt'">
		<svg :width="width" :height="height" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
<path d="M16 12H22L19 9M20 14L19 15M8 12H2L5 15M4 10L5 9M12 8V2L9 5M14 4L15 5M12 16V22L15 19M10 20L9 19" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
</svg>
