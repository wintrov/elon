...
<path opacity="0.4" d="M10 18H14" stroke="currentColor" stroke-width="1.5" stroke-linecap="round"/>
<path d="M3 6H21M6 12H18" stroke="currentColor" stroke-width="1.5" stroke-linecap="round"/>
</svg>
...
<path d="M3 6H21M6 12H18M10 18H14" stroke="currentColor" stroke-width="1.5" stroke-linecap="round"/>
	...
	<template v-else-if="variant === 'gestalt'">
		<svg :width="width" :height="height" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
<path d="M3 6H13M17 6H21M6 12H18M10 18H14" stroke="currentColor" stroke-width="1.5" stroke-linecap="round"/>
</svg>
