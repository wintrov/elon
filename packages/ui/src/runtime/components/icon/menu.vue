...
<path opacity="0.4" d="M3 18H21" stroke="currentColor" stroke-width="1.5" stroke-linecap="round"/>
<path d="M3 6H21M3 12H21" stroke="currentColor" stroke-width="1.5" stroke-linecap="round"/>
</svg>
...
<path d="M3 6H21M3 12H21M3 18H21" stroke="currentColor" stroke-width="1.5" stroke-linecap="round"/>
	...
	<template v-else-if="variant === 'gestalt'">
		<svg :width="width" :height="height" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
<path d="M3 6H21M3 12H13M17 12H21M21 18H11M3 18H7" stroke="currentColor" stroke-width="1.5" stroke-linecap="round"/>
</svg>
